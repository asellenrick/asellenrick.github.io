...
const IndexPage = () => (
	<>
		<Helmet
			title="Andrew Sellenrick - Designer and Developer in Nebraska"
			meta={[
				{
					name: 'description',
					content: 'Andrew Sellenrick Designer and Developer living in Nebraska'
				},
				{
					name: 'keywords',
					content: 'designer, developer, interface design, coder, portfolio, ui, ux'
				}
			]}></Helmet>
		<Layout>
			<section id="banner">
